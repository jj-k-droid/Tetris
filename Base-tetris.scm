...
(define I
  (let* ([color (rgb 1 230 254)]
         [flat (beside (tetris-square 20 color) (tetris-square 20 color) (tetris-square 20 color) (tetris-square 20 color))]
         [i (above (tetris-square 20 color) (tetris-square 20 color) (tetris-square 20 color) (tetris-square 20 color))])
...
(define J
  (let* ([color (rgb 24 1 255)]
         [flat (above/align "left" (tetris-square 20 color)
                            (beside (tetris-square 20 color) (tetris-square 20 color) (tetris-square 20 color)))]
         [filpped-j (beside/align "top" 
                                      (above (tetris-square 20 color) (tetris-square 20 color) (tetris-square 20 color))
                                      (tetris-square 20 color))]
         [filpped-flat (above/align "right" (beside (tetris-square 20 color) (tetris-square 20 color) (tetris-square 20 color))
                                        (tetris-square 20 color))]
         [j (beside/align "bottom" (tetris-square 20 color)
                          (above (tetris-square 20 color) (tetris-square 20 color) (tetris-square 20 color)))])
...
(define L
  (let* ([color (rgb 255 115 9)]
         [flat (above/align "right" (tetris-square 20 color)
                            (beside (tetris-square 20 color) (tetris-square 20 color) (tetris-square 20 color)))]
         [l (beside/align "bottom" 
                          (above (tetris-square 20 color) (tetris-square 20 color) (tetris-square 20 color))
                          (tetris-square 20 color))]
         [filpped-flat (above/align "left" (beside (tetris-square 20 color) (tetris-square 20 color) (tetris-square 20 color) )
                                        (tetris-square 20 color))]
         [filpped-l (beside/align "top" (tetris-square 20 color)
                                       (above (tetris-square 20 color) (tetris-square 20 color) (tetris-square 20 color)))])
...
(define O
  (let* ([color (rgb 255 222 2)]
         [o (above (beside (tetris-square 20 color) (tetris-square 20 color))
                   (beside (tetris-square 20 color) (tetris-square 20 color)))])
...
(define S
  (let* ([color (rgb 102 253 3)]
         [s (above (beside (block (rgb 0 0 0 0)) (tetris-square 20 color) (tetris-square 20 color))
                   (beside (tetris-square 20 color) (tetris-square 20 color) (block (rgb 0 0 0 0))))]
         [vertical-s (beside (above (tetris-square 20 color) (tetris-square 20 color) (block (rgb 0 0 0 0)))
                             (above (block (rgb 0 0 0 0)) (tetris-square 20 color) (tetris-square 20 color)))])
...
(define Z
  (let* ([color (rgb 254 17 60)]
         [z (above (beside (tetris-square 20 color) (tetris-square 20 color) (block (rgb 0 0 0 0)))
                   (beside (block (rgb 0 0 0 0)) (tetris-square 20 color) (tetris-square 20 color)))]
         [vertical-z (beside (above (block (rgb 0 0 0 0)) (tetris-square 20 color) (tetris-square 20 color))
                             (above (tetris-square 20 color) (tetris-square 20 color) (block (rgb 0 0 0 0))))])
...
(define T
  (let* ([color (rgb 184 3 253)]
         [flat (above/align "middle" (tetris-square 20 color)
                            (beside (tetris-square 20 color) (tetris-square 20 color) (tetris-square 20 color)))]
         [vertical-1 (beside/align "center" (above (tetris-square 20 color) (tetris-square 20 color) (tetris-square 20 color))
                                   (tetris-square 20 color))]
         [flipped-flat (above/align "middle" 
                                    (beside (tetris-square 20 color) (tetris-square 20 color) (tetris-square 20 color))
                                    (tetris-square 20 color))]
         [vertical-2 (beside/align "center" (tetris-square 20 color)
                                   (above (tetris-square 20 color) (tetris-square 20 color) (tetris-square 20 color)))])
